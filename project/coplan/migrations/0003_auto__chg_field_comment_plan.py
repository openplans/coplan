...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.plan'
        db.alter_column('coplan_comment', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplan.Plan']))

    def backwards(self, orm):

        # Changing field 'Comment.plan'
        db.alter_column('coplan_comment', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coplan.Comment']))
