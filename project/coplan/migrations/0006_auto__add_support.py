...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coplan_support', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('supporter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='support', to=orm['auth.User'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='support', to=orm['coplan.Plan'])),
            ('motivation', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('coplan', ['Support'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('coplan_support')
